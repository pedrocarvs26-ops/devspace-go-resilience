# Dev Space Go (Go Edition) - فارسی

**به ChatGPT و Claude دسترسی امن به ماشین محلی خود بدهید. هر میزبان MCP را به شریک کدنویسی خود تبدیل کنید.**

Dev Space Go یک سرور MCP خودمیزبان است که به دستیارهای هوش مصنوعی اجازه می‌دهد کد را در پروژه‌های محلی واقعی شما بخوانند، ویرایش کنند، جستجو کنند و اجرا کنند — فایل‌های شما، ابزارهای شما، ترمینال شما — بدون آپلود هیچ چیزی به شخص ثالث. شما آن را روی ماشین خود اجرا می‌کنید.
...
برای نسخه وب ChatGPT (نیاز به HTTPS)، Dev Space Go به طور خودکار یک تونل را شروع می‌کند:
