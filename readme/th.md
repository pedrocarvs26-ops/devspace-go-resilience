# Dev Space Go (รุ่น Go)

**ให้ ChatGPT และ Claude เข้าถึงเครื่องท้องถิ่นของคุณอย่างปลอดภัย เปลี่ยนโฮสต์ MCP ใดๆ ให้เป็นคู่หูเขียนโค้ดของคุณ**

Dev Space Go คือเซิร์ฟเวอร์ MCP แบบโฮสต์เองที่ให้ผู้ช่วย AI อ่าน แก้ไข ค้นหา และรันโค้ดในโปรเจกต์ท้องถิ่นจริงของคุณ — ไฟล์ของคุณ เครื่องมือของคุณ เทอร์มินัลของคุณ — โดยไม่ต้องอัปโหลดอะไรไปยังบุคคลที่สาม คุณรันมันบนเครื่องของคุณ เปิดเผยผ่านทันเนลที่คุณควบคุม และป้องกันด้วยรหัสผ่านได้ตามต้องการ
...
สำหรับ ChatGPT เวอร์ชันเว็บ (ต้องใช้ HTTPS) Dev Space Go จะเริ่มทันเนลโดยอัตโนมัติ:
