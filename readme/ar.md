# Dev Space Go (Go Edition) - العربية

**امنح ChatGPT و Claude وصولاً آمناً إلى جهازك المحلي. حوّل أي مضيف MCP إلى شريك برمجة خاص بك.**

Dev Space Go هو خادم MCP ذاتي الاستضافة يتيح للمساعدين الذكاء الاصطناعي قراءة وتحرير والبحث وتشغيل الكود في مشاريعك المحلية الحقيقية — ملفاتك، أدواتك، الطرفية الخاصة بك — دون تحميل أي شيء إلى طرف ثالث. تقوم بتشغيله على جهازك، وتعرضه عبر نفق تتحكم به.
...
لإصدار ChatGPT على الويب (يتطلب HTTPS)، يبدأ Dev Space Go نفقاً تلقائياً:
