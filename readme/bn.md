# Dev Space Go (Go Edition) - বাংলা

**ChatGPT ও Claude-কে আপনার স্থানীয় মেশিনে নিরাপদ অ্যাক্সেস দিন। যেকোনো MCP হোস্টকে আপনার কোডিং পার্টনারে রূপান্তর করুন।**

Dev Space Go হল একটি স্ব-হোস্টেড MCP সার্ভার যা AI সহায়কদের আপনার বাস্তব স্থানীয় প্রকল্পগুলিতে কোড পড়তে, সম্পাদনা করতে, অনুসন্ধান করতে এবং চালাতে দেয় — আপনার ফাইল, আপনার সরঞ্জাম, আপনার টার্মিনাল — কোনো তৃতীয় পক্ষের কাছে কিছু আপলোড না করেই। আপনি এটি আপনার মেশিনে চালান.
...
ChatGPT ওয়েব সংস্করণের জন্য (HTTPS প্রয়োজন), Dev Space Go স্বয়ংক্রিয়ভাবে একটি টানেল শুরু করে:
