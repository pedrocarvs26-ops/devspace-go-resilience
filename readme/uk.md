...
Dev Space Go — це самостійно розміщений MCP-сервер, який дозволяє AI-асистентам читати, редагувати, шукати та запускати код у ваших реальних локальних проєктах — ваші файли, ваші інструменти, ваш термінал — без завантаження чого-небудь третім сторонам. Ви запускаєте його на своєму комп'ютері.
...
Для веб-версії ChatGPT (потрібен HTTPS) Dev Space Go автоматично запускає тунель:
